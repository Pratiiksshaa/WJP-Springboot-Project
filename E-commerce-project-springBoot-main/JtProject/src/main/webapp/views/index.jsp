...
<nav class="navbar navbar-expand-lg navbar-light bg-light" >
    <div class="container-fluid">
        <a class="navbar-brand" href="#">
           <img src="https://w7.pngwing.com/pngs/384/470/png-transparent-retail-computer-icons-e-commerce-sales-mega-offer-miscellaneous-service-logo.png" width="auto" height="40" class="d-inline-block align-top" alt=""/>
        </a>
        ...
        <h4>Welcome ${ username } to Digital store</h4>
              ...
              <div class="container text-center">
                <div class="row">
                  <div class="col-sm-6 image">
                    <div class="item">
                      <h1>Today's Deal</h1>
                      <img class="img-fluid" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSvSYCSSPRlzvQfT6_bnlED1JshK0LEVh2SDbWIHqAFYdk-9LVnonzrzbeEcqggNQ8mQng&usqp=CAU" alt="">
                    </div><!--enditem-->
                  </div><!--endcol-->
                  <div class="col-sm-6">
                    ...
                    <div class="details">
                      <h2 class="cr3"> TV</h2>
                      <p class="cr4">SAMSUNG 80 cm (32 Inch) HD <br> Ready LED Smart Tizen TV.</p>
                      <div class="rating">
                      ...
                      <p class="cr1">Rs. 14999-Rs. 54999</s></p>
                  <a href="/user/products" class="btn btn-product">Buy Now</a>
                </div><!--enddetails-->
              </div><!--endcol-->
            </div><!--endrow-->
          </div><!--endcontainer-->
          ...
          <div class="container text-center">
            <div class="row">
              <div class="col-sm-6 image">
                <div class="item">
                  <h1>Today's Deal</h1>
                  <img class="img-fluid" src=" https://in-exstatic-vivofs.vivo.com/gdHFRinHEMrj3yPG/1663840985603/a4f2d38f3048e8aa3e288071e93c2ac0.png" alt="">
                </div><!--enditem-->
              </div><!--endcol-->
              <div class="col-sm-6">
                <div class="top d-flex justify-content-center">
                ...
                <div class="details">
                  <h2 class="cr3">Mobile</h2>
                  <p class="cr4">APPLE iPhone 14 (Blue, 128 GB)<br> Special PriceGet extra Rs.5910 off (price inclusive of cashback/coupon)T&C�.</p>
                  <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                  ...
                  <p class="cr1">Rs.5000.50-Rs.29999.00</s></p>
              <a href="/user/products" class="btn btn-product">Buy Now</a>
            </div><!--enddetails-->
          </div><!--endcol-->
        </div><!--endrow-->
          ...
          <div class="container text-center">
            <div class="row">
              <div class="col-sm-6 image">
                <div class="item">
                  <h1>Today's Deal</h1>
   <img class="img-fluid" src="https://i.dell.com/is/image/DellContent/content/dam/ss2/product-images/dell-client-products/notebooks/latitude-notebooks/15-5531/media-gallery/notebooks-latitude-15-5531-gray-gallery-3.psd?fmt=png-alpha&pscan=auto&scl=1&wid=4888&hei=4494&qlt=100,1&resMode=sharp2&size=4888,4494&chrss=full&imwidth=5000== " alt="">
                </div><!--enditem-->
              </div><!--endcol-->
              <div class="col-sm-6">
                <div class="top d-flex justify-content-center">
                ...
                <div class="details">
                  <h2 class="cr3">Laptop</h2>
                  <p class="cr4">APPLE 2020 Macbook Air M1<br>(8 GB/256 GB SSD/Mac OS Big Sur) MGN93HN/A  (13.3 inch, Silver, 1.29 kg).</p>
                  <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                  ...
                  <p class="cr1">Rs. 30000.55-Rs. 55499.55</s></p>
              <a href="/user/products" class="btn btn-product">Buy Now</a>
            </div><!--enddetails-->
          </div><!--endcol-->
        </div><!--endrow-->
...
<div class="row">
   <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4" data-aos="zoom-in-down">
                            <div class="card">
                                <a class="img-card">
                                    <img src="https://sfmagazine.com/wp-content/uploads/2016/09/10_2016_techforum.jpg" />
...
<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4" data-aos="zoom-in-down">
                            <div class="card">
                                <a class="img-card">
                                    <img src="https://squaregroup.com/media/images/Contact_Us_Sbq0zek.2e16d0ba.fill-1920x1080.jpg" />
